...
public class MainActivity extends AppCompatActivity {
    ...
    private void setUpViewPager() {
        ...
        tabLayout.getTabAt(1).setText(getResources().getString(R.string.mascotas));
        tabLayout.getTabAt(1).setIcon(R.drawable.ic_mascotas);
        tabLayout.getTabAt(0).setText(getResources().getString(R.string.mimascotatitulo));
        tabLayout.getTabAt(0).setIcon(R.drawable.ic_mimascota);
